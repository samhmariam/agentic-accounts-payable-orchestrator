        ...
        *,
        ...
        with start_observability_span(
            ...
            attributes=node_span_attributes(
                node_name="postgres_checkpoint_write",
                idempotent=False,
            ...
            checkpoint = self.store.insert_checkpoint(
                thread_id=state.thread_id,
                node_name=node_name,
            ...
            add_span_event(
                "checkpoint_restored" if is_interrupt_checkpoint else "cache_miss",
                {
                    "error_class": "none",
                    "attempt_number": 1,
                    "backoff_ms": 0,
                    ...
                    "decision_reason_code": "CHECKPOINT_SAVED",
                },
            )
            return checkpoint
    ...
    def load_latest_checkpoint(
        ...
        *,
        ...
        with start_observability_span(
            "dep.postgres.read",
            attributes=node_span_attributes(
                node_name="postgres_checkpoint_read",
                idempotent=True,
            ...
            add_span_event(
                "checkpoint_restored",
                {
                    ...
                    "remaining_budget_ms": 0,
                    "dependency_name": "postgres",
                    "decision_reason_code": "CHECKPOINT_RESTORED",
                },
            )
