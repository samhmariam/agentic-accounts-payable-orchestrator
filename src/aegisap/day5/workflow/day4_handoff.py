...
def bootstrap_durable_state_from_day4(
    ...
    *,
    ...
    return DurableWorkflowState(
        ...
        task_class=day4_state.task_class,
        risk_flags=list(day4_state.risk_flags),
        routing_decision=dict(day4_state.routing_decision),
        model_deployment=day4_state.model_deployment,
        cache_hit=day4_state.cache_hit,
        workflow_cost_estimate=day4_state.workflow_cost_estimate,
        cost_ledger=list(day4_state.cost_ledger),
        evidence_conflict_count=day4_state.evidence_conflict_count,
        retrieval_confidence=day4_state.retrieval_confidence,
