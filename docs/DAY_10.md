...
Day 10 is the Capstone A foundation checkpoint. The release packet built here is
required input to the final Day 14 CAB defense; it is not the capstone closeout.
